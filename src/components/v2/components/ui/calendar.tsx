  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border border-gray-200 hover:bg-gray-100 rounded-md flex items-center justify-center transition-colors"
        ),
        ...
        day: cn(
          "h-9 w-9 p-0 font-normal aria-selected:opacity-100 hover:bg-gray-100 rounded-md flex items-center justify-center transition-colors cursor-pointer"
        ),
