...
const sheetVariants = cva(
  "fixed z-[999] gap-4 bg-card p-6 shadow-lg transition ease-in-out data-[state=open]:animate-slide-in data-[state=closed]:animate-slide-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
