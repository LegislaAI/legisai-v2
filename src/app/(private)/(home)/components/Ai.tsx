...
export function Ai() {
  return (
    <div className="relative flex h-96 w-1/2 flex-col justify-between rounded-lg bg-white p-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <span className="text-dark font-semibold">Legis AI</span>
          <Info className="text-light-dark" />
        </div>
        <div className="text-light-dark flex items-center gap-2 rounded-lg border px-4 py-2">
      ...
      <div className="w-[700px]">
        <Swiper slidesPerView={2} spaceBetween={10} centeredSlides>
          <SwiperSlide>
