          ...
          <div
            className={`col-span-12 ${
              visibleSections.includes(4)
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            } flex flex-col justify-between gap-4 rounded-lg bg-[url(/static/card.png)] bg-cover bg-center p-2 px-4 text-white shadow-lg transition-all duration-300 md:col-span-7 xl:col-span-4 xl:row-span-4`}
          >
