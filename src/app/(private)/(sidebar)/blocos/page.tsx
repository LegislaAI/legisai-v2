...
export default function BlocosPage() {
  ...
  useEffect(() => {
    async function loadBlocos() {
      ...
      const { ok, body, dados } = await fetchCamara<Bloco[]>("blocos", params);
      if (ok) {
        ...
        <div className="space-y-8">
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#749c5b]/10 via-[#4E9F3D]/5 to-transparent px-6 py-8">
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div className="flex items-center gap-3">
                ...
                >
                  <Layers className="h-6 w-6 text-[#749c5b]" />
                </div>
                <div>
                  ...
                  <p className="mt-1 max-w-xl text-sm text-gray-600">
                    Blocos de partidos na Câmara. Filtre por legislatura e clique para ver os partidos do bloco.
                  </p>
                </div>
                <Tooltip>
                  ...
                  <TooltipContent side="left" className="max-w-[260px] border-gray-200 bg-white text-xs shadow-lg">
                    Blocos reúnem partidos com atuação conjunta. Dados da API Dados Abertos.
                  </TooltipContent>
                </Tooltip>
              </div>
          ...
          {loading ? (
            ...
            <Card className="border-gray-100 p-12 text-center">
              ...
              <h3 className="text-lg font-bold text-gray-800">Nenhum bloco encontrado</h3>
              <p className="mt-2 text-sm text-gray-500">
                Tente outra legislatura ou verifique o proxy <code className="rounded bg-gray-100 px-1">/camara/blocos</code>.
              </p>
            </Card>
          )}
        </div>
