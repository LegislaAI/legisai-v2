  ...
  return (
    <>
      <div className="relative flex h-full flex-col items-center">
        <div className="pointer-events-none absolute top-0 left-0 flex h-full w-full items-center justify-center bg-white/50 backdrop-blur-sm">
          <Image
            src="/static/soon.png"
            alt=""
            width={1000}
            height={1000}
            className="h-max w-2/3 object-contain xl:w-96"
          />
        </div>
        {/*    <h1 className="mb-4 text-3xl font-bold">IA Preditiva</h1>
        <p className="mb-12 w-full text-center text-lg xl:w-1/2">
          Uma tecnologia revolucionária que permite prever votações em Projetos
          de Lei, analisar as intenções dos parlamentares, entender seus votos,
          identificar os setores beneficiados e muito mais — tudo isso com o
          poder da Inteligência Artificial preditiva do LegisDados
        </p>
