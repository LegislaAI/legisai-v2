    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-white p-6">
      <div className="w-full max-w-3xl rounded-2xl border border-white/20 bg-white/10 p-8 shadow-xl backdrop-blur-sm">
        ...
        <div className="space-y-4 text-sm leading-relaxed text-black">
          <p>
            A sua privacidade é importante para nós. É política do Legis AI
            respeitar a sua privacidade em relação a qualquer informação sua que
            possamos coletar no site Legis AI , e outros sites que possuímos e
            operamos.
          </p>
          ...
          <div className="mt-6 border-t border-white/20 pt-4">
            ...
            <p className="mb-2">
              ...
              informação que o Legis AI oferece no site e com caráter
            ...
            <ul className="ml-2 list-inside list-disc space-y-1">
              ...
              <li>
                ...
                lógicos (softwares) do Legis AI, de seus fornecedores ou
          ...
          <div className="mt-6 border-t border-white/20 pt-4">
            ...
            <p className="text-light-dark/70 mt-4 text-xs">
              Esta política é efetiva a partir de 31 Janeiro de 2025 20:53
            </p>
          </div>
        </div>
